...
  // ⚠️ CHANGE: Removed the unnecessary useEffect cleanup hook. 
  // The cleanup is now handled robustly in auth-context.tsx.
  // 
  // useEffect(() => {
  //   return () => {
...
      // The error.message.includes('reCAPTCHA') check is still good to have.
