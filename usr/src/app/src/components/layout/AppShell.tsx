                    ...
                    {loading ? (
                      ...
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                          <Avatar className="cursor-pointer h-10 w-10 border-2 border-background shadow-md">
                            <AvatarImage src={authUser.photoURL || `https://picsum.photos/seed/${authUser.uid}/40/40`} data-ai-hint="person face"/>
